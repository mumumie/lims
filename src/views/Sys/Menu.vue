<template>
  <div class="page-container">
    <tip :value="
    ['分为2种，菜单(最大级的称为目录)和按钮。依次是目录-菜单-按钮',
    '菜单的地址和代码文件路径对应，用户一般不操作此页面']" />
	<!--工具栏-->
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<kt-button icon="fa fa-search" :label="$t('action.search')" perms="" type="primary" @click="findTreeData(null)"/>
			</el-form-item>
			<el-form-item>
    ...
    <!-- 新增修改界面 -->
    <el-dialog :title="!dataForm.id ? '新增' : '修改'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false" append-to-body>
  ...
  methods: {
    ...
    findTreeData: function() {
      ...
      this.$api.menu.findMenuTree().then(res => {
        ...
        this.popupTreeData = this.getParentMenuTree(res.bean.data);
        this.loading = false;
      });
    },
    // 获取上级菜单树
