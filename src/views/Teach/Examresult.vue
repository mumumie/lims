...
<!--            <span v-if="item.type===4" :class="checkResult(item.blankAnswer.toString())=== checkResult(examResultAnswerList[index].blankAnswer.toString())?'success_bg':'error_bg'">-->
    ...
    methods: {
      ...
      findPage: function (data) {
        ...
        if(this.filters.name){
          pageRequest.condition.examPaperId =  this.filters.name;
        }
      ...
      initColumns: function () {
        this.columns = [
          ...
          {prop:"examPaper.scoreSum", label:"试卷总分", minWidth:120},
      ...
      getStatus:function(){
        ...
        this.$api.examresult.findPage({pageNum: 1, condition:{status:1}}).then((res) => {
